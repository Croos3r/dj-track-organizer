...
const mockRows = [
  {
    old: 'Insomniak, Drymk - 1312 (Drymk Remix).wav',
    new: 'Drymk, Insomniak - 1312 (Drymk Remix).wav',
    origin: 'filename',
  },
  {
    old: '01 Some Artist - Some Title.mp3',
    new: 'Some Artist - Some Title.mp3',
    origin: 'filename',
  },
  {
    old: 'Angerfist - And Jesus Wept.wav',
    new: 'Angerfist - And Jesus Wept.wav',
    origin: 'filename',
  },
];
...
async function mockInvoke(cmd: string, args?: Record<string, unknown>): Promise<unknown> {
  ...
  switch (cmd) {
    case 'get_settings':
      return {
        last_folder: 'C:\\Users\\You\\Music\\Track',
        master_db: null,
        backup_dir: null,
        duplicates_dir: null,
    ...
    case 'save_settings':
      return null;
    case 'pick_folder':
      return 'C:\\Users\\You\\Music\\Track';
    case 'reveal_path':
      return null;
    case 'health_scan':
      return {
        ...
        issues: [
          ...
          },
          {
            id: 'manual-review',
            severity: 'warning',
            title: 'Files need manual naming',
            count: 1,
            description: 'The normalizer could not confidently derive both an artist and a title.',
          },
          {
            id: 'file-duplicates',
            severity: 'warning',
            ...
            count: 1,
            description:
              '1 duplicate group found. Review the existing duplicate workflow before moving anything.',
          },
          {
            id: 'missing-rekordbox-files',
            severity: 'critical',
            title: 'Rekordbox files missing from disk',
            count: 3,
            description:
          ...
          },
          {
            ...
            severity: 'warning',
            title: 'Duplicate Rekordbox entries found',
            count: 2,
            description:
    ...
    case 'scan_plan':
      return {
        ...
        total: 1172,
        to_rename: 2,
        already_correct: 1169,
        manual: ['Mastering msbtwu.wav'],
        used_tags: true,
      };
    case 'apply_renames':
      return {
        renamed: 2,
        skipped: 0,
        rollback_path: '…\\rename_rollback.csv',
        plan_path: '…\\rename_plan.csv',
      };
    case 'tag_folder': {
      for (let i = 1; i <= 10; i++) {
    ...
    case 'rekordbox_apply':
      ...
      return {
        changed: (args?.plan as unknown[]).length,
        backup_path: '…\\rekordbox_backups\\master.db.20260712.bak',
      };
    case 'dedup_scan':
      return {
        groups: [
    ...
    case 'rekordbox_dedup_scan':
      return {
        entries: 1174,
        extras: 2,
        report_path: '…\\rekordbox_duplicates.csv',
        groups: [
          {
            kind: 'same-file',
            keeper: {
              id: '1',
              path: 'D:/Music/Track/Alpha - One.wav',
              ext: '.wav',
              title: 'One',
              created: '2026-01-01',
              cue_ids: ['a', 'b'],
            ...
            extras: [
              {
                id: '2',
                path: 'd:\\music\\track\\alpha - one.wav',
                ext: '.wav',
                title: 'One',
                created: '2026-02-01',
                cue_ids: [],
          ...
          },
          {
            ...
            keeper: {
              id: '3',
              path: 'D:/Music/Track/Beta - Two.wav',
              ext: '.wav',
              title: 'Two',
              created: '2026-01-01',
              cue_ids: [],
            ...
            extras: [
              {
                id: '4',
                path: 'D:/Music/Track/Beta - Two.mp3',
                ext: '.mp3',
                title: 'Two',
                created: '2026-01-01',
                cue_ids: ['c'],
